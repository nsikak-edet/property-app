...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/css/rtl/bootstrap<?php $ci = &get_instance();
                                                                                                            echo ($ci->session->userdata('mode') != null) ? "-dark" : ""
                                                                                                            ?>.css" class="theme-settings-bootstrap-css">
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/css/rtl/appwork<?php echo ($ci->session->userdata('mode') != null) ? "-dark" : "" ?>.css" class="theme-settings-appwork-css">
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/css/rtl/theme-corporate<?php echo ($ci->session->userdata('mode') != null) ? "-dark" : "" ?>.css" class="theme-settings-theme-css">
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/css/rtl/colors<?php echo ($ci->session->userdata('mode') != null) ? "-dark" : "" ?>.css" class="theme-settings-colors-css">
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/css/rtl/uikit.css">

    <!--        <link rel="stylesheet" href="--><?php //echo base_url("assets/adminv2/assets/")   
                                                ?>
    <!--css/demo.css">-->
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/libs/perfect-scrollbar/perfect-scrollbar.css">
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.css">
    <link rel="stylesheet" href="<?php echo base_url("assets/adminv2/assets/") ?>vendor/libs/perfect-scrollbar/perfect-scrollbar.css">
...
<body>
        ...
        <div class="layout-inner">
            ...
            <div id="layout-sidenav" class="layout-sidenav sidenav sidenav-vertical bg-dark">
                ...
                <div class="app-brand demo">
                    ...
                    <a href="javascript:void(0)" class="layout-sidenav-toggle sidenav-link text-large ml-auto" title="Expand/Collapse">
                ...
                <ul class="sidenav-inner py-1">
                    ...
                    <?php if ($this->authenticate->isAdmin() || $this->authenticate->isSuperAdmin()) : ?>
                        ...
                        <li class="sidenav-item <?php echo openSideNav('company'); ?>">
                            <a href="<?php echo base_url("company/") ?>" class="sidenav-link"><i class="sidenav-icon ion ion-ios-business"></i>
                                <div>Companies</div>
                            </a>
                        </li>

                        <li class="sidenav-item <?php echo openSideNav('contact'); ?>">
                            <a href="<?php echo base_url("contact/") ?>" class="sidenav-link"><i class="sidenav-icon ion ion-ios-contacts"></i>
                                <div>Contacts</div>
                            </a>
                        </li>

                        <li class="sidenav-item <?php echo openSideNav('property'); ?>">
                            <a href="<?php echo base_url("property/") ?>" class="sidenav-link"><i class="sidenav-icon ion ion-ios-home"></i>
                                <div>Properties</div>
                            </a>
                        </li>

                        <li class="sidenav-item <?php echo openSideNav('property'); ?>">
                            <a href="<?php echo base_url("forsale/") ?>" class="sidenav-link"><i class="sidenav-icon ion ion-ios-home"></i>
                                <div>For Sale</div>
                            </a>
                        </li>

                        <li class="sidenav-item <?php echo openSideNav('property'); ?>">
                            <a href="<?php echo base_url("activebuyer/") ?>" class="sidenav-link"><i class="sidenav-icon ion ion-ios-contacts"></i>
                                <div>Buyers</div>
                            </a>
                        </li>

                        <li class="sidenav-item <?php echo openSideNav('duplicate'); ?>">
                            <a href="javascript:void(0)" class="sidenav-link sidenav-toggle"><i class="sidenav-icon ion ion-ios-link"></i>
                                <div>Duplicates</div>
                            </a>
                            <ul class="sidenav-menu">
                                <li class="sidenav-item <?php echo openSideNav('duplicate'); ?>">
                                ...
                                <li class="sidenav-item">
                                    <a href="<?php echo base_url("duplicate/property/") ?>" class="sidenav-link">
                                        <div>Property</div>
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="layout-container">
                ...
                <nav class="layout-navbar navbar navbar-expand-lg bg-secondary align-items-lg-center container-p-x" id="layout-navbar">
                    ...
                    <div class="layout-sidenav-toggle navbar-nav d-lg-none align-items-lg-center mr-auto">
                        <a class="nav-item nav-link px-0 mr-lg-4" href="javascript:void(0)" title="Expand/Collapse">
                            ...
                            <div class="demo-navbar-user nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                                    <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                        <img src="<?php echo base_url("assets/adminv2/assets/") ?>img/avatars/1.png" alt class="d-block ui-w-30 rounded-circle">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?php echo base_url('user/edit/' . $user->user_id); ?>" class="dropdown-item"><i class="ion ion-md-settings text-lightest"></i> &nbsp; Account settings</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="<?php
                                                echo ($this->authenticate->isAdmin() || $this->authenticate->isSuperAdmin() || $this->authenticate->isReviewer()) ?
                                                    base_url("user/logout") : base_url("user/logout");
                                                ?>" class="dropdown-item"><i class="ion ion-ios-log-out text-danger"></i> &nbsp; Log Out</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo base_url("assets/adminv2/assets/") ?>vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js"></script>
    ...
    <script src="<?php echo base_url("assets/adminv2/assets/") ?>js/jquery.serializejson.min.js"></script>

    <!--<script src="--><?php //echo base_url("assets/adminv2/assets/")   
                        ?>
    <!--vendor/libs/smart-sticky/dist/js/jquery.smartSticky.min.js"></script>-->
    <!--<script src="--><?php //echo base_url("assets/adminv2/assets/")   
                        ?>
    <!--vendor/libs/bootstrap-tagsinput/bootstrap-tagsinput.js"></script>-->
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#datepicker-base,.datepicker-base').datepicker({
