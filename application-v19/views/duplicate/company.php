                        ...
                        <div class="card-body">
                            <div class="form-row">                                            
                                <div class="form-group col-md-10 ">
                                    <label class="form-label">Fields to search for duplicate companies (field match)</label>
                            ...
                            <div class="form-row">
                                <div class="mt-2 col-lg-12">
                                    ...
                                    <a style="margin-left:5px;" href="<?php echo base_url('duplicate/clear_company_search') ?>" class="btn btn-outline-secondary mt-3">Clear Options</a>
                                </div>
                            </div>
                        </div>
                    </div>
