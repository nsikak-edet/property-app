...
class Contact extends CI_Controller
{
			...
			if ($this->input->server('REQUEST_METHOD') == 'POST') {
				...
				if (($this->form_validation->run())) {
					...
					$searchCriteria = array(
						...
						'landlord_responsibilities' => $this->input->post('landlord_responsibilities', true),
					...
					$this->Contact_model->update_contact($data['contact']['contact_id'], $searchCriteria);
					$this->session->set_flashdata("success", "contact search criteria updated updated");
	...
	private function getContactData()
	{
		...
		// $formData['acquisition_criteria_date'] = ($acquisitionCriteriaDate != null) ? date('Y-m-d', strtotime($acquisitionCriteriaDate)) : null;
		// $formData['states'] = $states;
		$formData['comment'] = $comment;
		// $formData['tenant_name'] = $tenantName;
