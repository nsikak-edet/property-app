									...
									<div class="card-body">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-4">
												...
												<input type="text" name="last_update" class="form-control daterange-picker-2" value="<?= (@$_GET['last_update'] != null) ? (@$_GET['last_update']) : ''; ?>" placeholder="Last update date">
											</div>
										</div>
										...
										<div class="form-row">
											<div class="form-group col-md-3">
												...
												<select class="form-control" value="<?php echo htmlspecialchars(@$search->contact_name); ?>" placeholder="Lead Gen Type" name="lead_gen_type">
													...
													<option value="<?= LeadGenOptions::MET ?>" <?= (@$search->lead_gen_type == LeadGenOptions::MET) ? "selected='selected'" : "" ?>>
														Met
													</option>
													<option value="<?= LeadGenOptions::HAVENT_MET ?>" <?= (@$search->lead_gen_type == LeadGenOptions::HAVENT_MET) ? "selected='selected'" : "" ?>>
														Haven't Met
													</option>
													<option value="<?= LeadGenOptions::MET_OR_HAVENT_MET ?>" <?= (@$search->lead_gen_type == LeadGenOptions::MET_OR_HAVENT_MET) ? "selected='selected'" : "" ?>>
														Met or Haven't Met
													</option>
													<option value="<?= LeadGenOptions::NOT_MET_OR_HAVENT_MET ?>" <?= (@$search->lead_gen_type == LeadGenOptions::NOT_MET_OR_HAVENT_MET) ? "selected='selected'" : "" ?>>
											...
											<div class="form-group col-md-2">
												...
												<select class="form-control" placeholder="Do Not Blast" name="do_not_blast">
													<option value="">Select Type</option>
													<option value="<?= DoNotSendOptions::YES ?>">
														Blank
													</option>
													<option value="<?= DoNotSendOptions::NO ?>" <?= (@$search->do_not_blast == 1) ? "selected='selected'" : "" ?>>
														Do Not Blast
													</option>
												</select>
											</div>
											...
											<div class="form-group col-md-4">
												...
												<select class="form-control" placeholder="Do Not Send" name="do_not_send">
													<option value="">Select Type</option>
													<option value="<?= DoNotSendOptions::YES ?>">
														Blank
													</option>
													<option value="<?= DoNotSendOptions::NO ?>" <?= (@$search->do_not_send == 1) ? "selected='selected'" : "" ?>>
														Do Not Send
													</option>
												</select>
											</div>
											...
											<div class="form-group col-md-3">
												...
												<select class="form-control" placeholder="Bad #" name="bad_no">
													...
													<option value="<?= DoNotSendOptions::NO ?>" <?= (@$search->bad_no == 1) ? "selected='selected'" : "" ?>>
														Bad #
													</option>
												</select>
											</div>
											...
											<div class="form-group col-md-6">
												...
												<div class="input-group">
													<input type="text" class="form-control daterange-picker" value="<?= (@$search->tax_record_sent_date != null) ? (@$search->tax_record_sent_date) : ''; ?>" name="tax_record_sent_date" placeholder="Tax Record Letter Sent Date">
												</div>
											</div>

											<div class="form-group col-md-6">
												<label class="form-label">Last Dial</label>
												<input type="text" name="last_dial" class="form-control lastdial-daterange" value="<?= (@$search->last_dial) ?>" placeholder="Last update date" />
											</div>
											...
											<div class="form-group col-md-3">
												...
												<select class="form-control" placeholder="Has Owner" name="has_owner">
													...
													<option value="<?= DoNotSendOptions::YES ?>" <?= (@$search->has_owner == 1) ? "selected='selected'" : "" ?>>
														Yes
													</option>
											...
											<div class="form-group col-md-3">
												<label class="form-label">Owner Phone: <span class="text-muted"><?php echo htmlspecialchars(@$search->owner_phone); ?></span></label>
												<select data-allow-clear="true" name="owner_phone" class="select2-field select2-field-phone" style="width:100%">
											...
											<div class="form-group col-md-3">
												<label class="form-label">Owner Street Address: <span class="text-muted"><?php echo htmlspecialchars(@$search->owner_address); ?></span></label>
												<select data-allow-clear="true" name="owner_address" class="select2-field select2-field-city" style="width:100%">
													<option value="empty">Is Empty</option>
													<option value="not-empty">Not Empty</option>
												</select>
											</div>
	...
	<div class="row">
		<div class="d-flex col-xl-12 align-items-stretch">
			<div class="card">
				...
				<div class="card-body">
					<a href="<?php echo base_url("property/export_properties") ?>" class="btn btn-xs btn-outline-primary mb-4">
				...
				<div class="card-body">
					<div class="btn-group" style="margin-left:-10px; padding-bottom:20px;">
						...
						<div class="dropdown-menu" style="">
							<a class="dropdown-item" href="<?php echo base_url("property/export_owners") ?>"><span class="fas fa-file-download"></span> Owners</a>
							<a class="dropdown-item" href="<?php echo base_url("property/export_company_owners") ?>"><span class="fas fa-file-download"></span> Companies</a>
							<a class="dropdown-item" href="<?php echo base_url("property/export_contact_owners") ?>"><span class="fas fa-file-download"></span> Contacts</a>
						</div>
					</div>
