                    ...
                    <div class="col-lg-12" style="float:right;">
                        <?php if (@$hideNext == false) : ?>
                            <ul class="pagination pagination-sm mb-0" style="float:right">
                                <?php if (@$hasPrevious) : ?>
                                    <li class="page-item">
                                        <a class="page-link btn-outline-secondary" href="<?php echo base_url('activebuyer/view/' . $property['property_id']); ?>?type=previous">Previous</a>
                                    </li>
                                <?php endif; ?>

                                <?php if (@$hasNext) : ?>
                                    <li class="page-item">
                                        <a class="page-link btn-outline-secondary ml-2" href="<?php echo base_url('activebuyer/view/' . $property['property_id']); ?>?type=next">Next</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        <?php endif; ?>
