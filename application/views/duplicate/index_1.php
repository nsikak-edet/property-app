    ...
    <div class="row">
        <div class="d-flex col-xl-12 align-items-stretch">
            ...
            <div class="card w-100 mb-1">
                <div class="card-body">   
                    <?php echo form_open(base_url("duplicate/"), ['method' => 'get']); ?>
                        ...
                        <div class="card-body">
                            <div class="form-row">                                            
                                ...
                                <div class="form-group col-md-2 ">                                    
                                    <button type="submit" class="btn btn-primary mt-4" name="duplicates" value="contact" type="button">Search Company</button>
                                </div>
                            </div>      
                ...
                <div class="card-body">                    
                    ...
                    <div class="form-group col-12 mb-0 ">
                        <div class="card-body">
                            <div class="form-row">                                            
                                <div class="form-group col-md-6 ">
                                    <label class="form-label">Fields to search for duplicate companies</label>
                                    <select data-allow-clear="true" name="company_duplicates[]" class="select2-fields" style="width:100%">                                                    
                                        <option value="address">Street</option>
                                        <option value="city">City</option>
                                        <option value="state">State</option>
                                ...
                                <div class="form-group col-md-4 ">                                    
                                    <button type="submit" class="btn btn-primary mt-4" name="duplicates" value="company" type="button">Search Companies</button>
                                </div>
                            </div>
                            <div class="form-row">                                            
                                <div class="form-group col-md-6 ">
                                    <label class="form-label">Fields to search for duplicate contacts</label>
                                    <select data-allow-clear="true" name="contact_duplicates[]" class="select2-contact-fields" style="width:100%">  
                                ...
                                <div class="form-group col-md-6 ">                                    
                                    <button type="submit" class="btn btn-primary mt-4" name="duplicates" value="contact" type="button">Search Contacts</button>
                                </div>
                            </div>                            
                        </div>
                    </div>
